...
int main(int argc, char *argv[])
{
  ...
  if (strcmp(bcast_implementation_name, "naive_bcast") &&
      ...
      strcmp(bcast_implementation_name, "bintree_bcast") &&
      strcmp(bcast_implementation_name, "pipelined_ring_bcast") &&
      strcmp(bcast_implementation_name, "non_blocking_pipelined_ring_bcast") &&
      strcmp(bcast_implementation_name, "non_blocking_pipelined_bintree_bcast")) {
    char message[256];
